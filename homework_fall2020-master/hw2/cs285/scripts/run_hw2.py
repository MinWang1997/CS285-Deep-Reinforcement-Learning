...
def main():
    ...
    parser.add_argument('--video_log_freq', type=int, default=-1)#frequency of video log
    parser.add_argument('--scalar_log_freq', type=int, default=1)

    parser.add_argument('--save_params', action='store_false')#store paramters and model by default
