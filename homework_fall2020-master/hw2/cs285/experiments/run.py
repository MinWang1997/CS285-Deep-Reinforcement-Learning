...
def run_exp_2(SEARCH = False):
    ...
    if SEARCH:
        ...
        template = "python cs285/scripts/run_hw2.py --env_name InvertedPendulum-v2 --ep_len 1000 --discount 0.9 -n 100 -l 2 -s 64 -b {bs} -lr {lr} -rtg --exp_name q2_b{bs}_r{lr}"
        ...
        seeds = [0]
        template = "python cs285/scripts/run_hw2.py --env_name InvertedPendulum-v2 --ep_len 1000 --discount 0.9 -n 100 -l 2 -s 64 -b {bs} -lr {lr} -rtg --exp_name ip_b{bs}_r{lr}_s{seed} --seed {seed}"
        lr = 2e-2
        bs = 300
        commands = []
        for seed in seeds:
...
def run_exp_4():
    if exp_4_SEARCH:
        ...
        template = 'python cs285/scripts/run_hw2.py --env_name HalfCheetah-v2 --ep_len 150 --discount 0.95 -n 100 -l 2 -s 32 -b {bs} -lr {lr} --video_log_freq -1 --reward_to_go --nn_baseline --exp_name hc_b{bs}_lr{lr}_nnbaseline'
        commands = []
        for lr in lrs:
            for bs in bss:
                command = template.format(lr=lr, bs=bs)
        ...
        bs = 30000
        commands = [
            'python cs285/scripts/run_hw2.py --env_name HalfCheetah-v2 --ep_len 150 --discount 0.95 -n 100 -l 2 -s 32 -b {bs} -lr {lr} --video_log_freq -1 --reward_to_go --nn_baseline --exp_name hc_b{bs}_lr{lr}_rtg_baseline',
            'python cs285/scripts/run_hw2.py --env_name HalfCheetah-v2 --ep_len 150 --discount 0.95 -n 100 -l 2 -s 32 -b {bs} -lr {lr} --video_log_freq -1 --reward_to_go               --exp_name hc_b{bs}_lr{lr}_rtg_nobaseline',
            'python cs285/scripts/run_hw2.py --env_name HalfCheetah-v2 --ep_len 150 --discount 0.95 -n 100 -l 2 -s 32 -b {bs} -lr {lr} --video_log_freq -1                --nn_baseline --exp_name hc_b{bs}_lr{lr}_nortg_baseline',
            'python cs285/scripts/run_hw2run_hw2.py --env_name HalfCheetah-v2 --ep_len 150 --discount 0.95 -n 100 -l 2 -s 32 -b {bs} -lr {lr} --video_log_freq -1                              --exp_name hc_b{bs}_lr{lr}_nortg_nobaseline'
        ]
...
def vis_p4():
    if P4_SEARCH:
        template = 'data/ip_b{bs}_r{lr}_InvertedPendulum-v2'
        metric_template = 'data/ip_b{bs}_r{lr}_InvertedPendulum-v2/metrics_{i}.json'
        ...
        with open('data/searched.pkl', 'wb') as f:
            pickle.dump(count, f)
            
        plot_hyper(count)
    else:
        metric_template = 'data/ip_b{bs}_r{lr}_s{seed}_InvertedPendulum-v2/metrics_{i}.json'
