...
#run Experiment 1.2 : behavioral cloning (BC) on two tasks: the Ant environment, Hopper environment 
# with same parameters: eval_batch_size 50000 --num_agent_train_steps_per_iter 10000

def run_1_2():
    os.system('python cs285/scripts/run_hw1.py --expert_policy_file cs285/policies/experts/Ant.pkl --env_name Ant-v2 --exp_name bc_ant --n_iter 1 --expert_data cs285/expert_data/expert_data_Ant-v2.pkl --eval_batch_size 50000 --num_agent_train_steps_per_iter 10000 --video_log_freq -1')
    os.system('python cs285/scripts/run_hw1.py --expert_policy_file cs285/policies/experts/Hopper.pkl --env_name Hopper-v2 --exp_name bc_hopper --n_iter 1 --expert_data cs285/expert_data/expert_data_Hopper-v2.pkl --eval_batch_size 50000 --num_agent_train_steps_per_iter 10000 --video_log_freq -1')

    
    
#run behavioral cloning policy with hyperparameter Exploring - amount of training steps
#with smaller eval_batch_size 5000
def run_1_3():
    seeds = range(5)
    template = "python cs285/scripts/run_hw1.py --expert_policy_file cs285/policies/experts/Ant.pkl --env_name Ant-v2 --exp_name hyper_ant_{num_iter}_seed_{seed} --n_iter 1 --expert_data cs285/expert_data/expert_data_Ant-v2.pkl --eval_batch_size 5000 --num_agent_train_steps_per_iter {num_iter} --seed {seed} --video_log_freq -1"
    iters = range(1000, 10000+1, 1000)
    commands = []
    for seed in seeds:
        for i in iters:
            command = template.format(num_iter=i, seed=seed)
            commands.append(command)#create multiple command list

    #run multiple command and log Experiment      
...
def run_2_2():
    cmd_bc = 'python cs285/scripts/run_hw1.py --expert_policy_file cs285/policies/experts/Humanoid.pkl --env_name Humanoid-v2 --exp_name p_2_2_bc --n_iter 1 --expert_data cs285/expert_data/expert_data_Humanoid-v2.pkl --eval_batch_size 5000 --num_agent_train_steps_per_iter 50000 --video_log_freq -1'

    cmd_dagger = 'python cs285/scripts/run_hw1.py --expert_policy_file cs285/policies/experts/Humanoid.pkl --env_name Humanoid-v2 --exp_name p_2_2_dagger --do_dagger --n_iter 100 --expert_data cs285/expert_data/expert_data_Humanoid-v2.pkl --eval_batch_size 5000 --num_agent_train_steps_per_iter 500 --video_log_freq -1'
